...
- [x] 10-05-PLAN.md — Pi kiosk smoke test (manual checkpoint)

### Phase 11: v2 Hardware Migration

**Goal:** Rewrite the sensor layer to match the v2 Pi 5 hat build — delete dead v1 collectors, add new v2 sensor collectors (LSM6DSOX+LIS3MDL IMU, DS18B20 1-Wire temps, VEML7700 light, SEN0460 PM2.5, INA226 power), replace the UGREEN front camera with the ELP 4K, bundle dead-code cleanup from the brain note, and update pyproject/config so the stack runs cleanly on the new Pi 5.
**Requirements**: TBD
**Depends on:** Phase 10
**Plans:** 5/5 plans complete

Plans:
- [x] 11-00-PLAN.md — Wave 0: RED test stubs + hardware discovery (DS18B20 IDs + ELP VID:PID)
- [x] 11-01-PLAN.md — Wave 1: LSM6DSOX sampler rewrite + LIS3MDL heading/complementary filter
- [x] 11-02-PLAN.md — Wave 2: DS18B20, VEML7700, SEN0460, INA226 collectors + vendored drivers
- [x] 11-03-PLAN.md — Wave 3: pyproject deps + config.yaml v2 rewrite + camera udev rule
- [x] 11-04-PLAN.md — Wave 4: pip_compositor delete, engine wiring, dead-code audit
