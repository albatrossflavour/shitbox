...
- [ ] **Phase 1: Boot Recovery** - System survives hard power cuts and starts cleanly every time
...
- [ ] 01-01-PLAN.md — Tests, synchronous=FULL, BootRecoveryService, orphan event closure
- [ ] 01-02-PLAN.md — Engine wiring, buzzer patterns, OLED status, Prometheus metric
